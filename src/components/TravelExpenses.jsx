...
// import React, { useState } from 'react';
// import { Save, LogOut, Eye, EyeOff, Plus, Trash2, Briefcase, FileText, MapPin, Loader2 } from 'lucide-react';
...
//   onDataChanged 
// }) => {
//   const [activeTab, setActiveTab] = useState('travel'); // 'travel' or 'misc'
//   const [isPreviewOn, setIsPreviewOn] = useState(true);
...
//   // ==========================================
//   // 2. MISCELLANEOUS EXPENSE STATE & LOGIC
//   // ==========================================
//   const [miscForm, setMiscForm] = useState({
//     employeeName: '', 
//     officeLocation: '',
//     items: [
//       { date: '', description: '', vendor: '', purpose: '', amount: '' }
//     ]
//   });

//   const handleMiscHeaderChange = (e) => {
//     const { id, value } = e.target;
//     setMiscForm(prev => ({ ...prev, [id]: value }));
//   };

//   const handleMiscEmployeeChange = (e) => {
//     setMiscForm(prev => ({ ...prev, employeeName: e.target.value }));
//   };
...
//     setMiscForm(prev => ({
//       ...prev,
//       items: [...prev.items, { date: '', description: '', vendor: '', purpose: '', amount: '' }]
//     }));
//   };

//   const removeMiscRow = (index) => {
//     if (miscForm.items.length > 1) {
//       const newItems = miscForm.items.filter((_, i) => i !== index);
//       setMiscForm(prev => ({ ...prev, items: newItems }));
//     }
//   };

//   const calculateMiscTotal = () => {
//     return miscForm.items.reduce((sum, item) => sum + parseFloat(item.amount || 0), 0);
//   };

//   const miscTotal = calculateMiscTotal();

//   // ==========================================
//   // 3. GLOBAL SAVE HANDLER
//   // ==========================================
//   const handleSave = async (e) => {
//     e.preventDefault();
...
//        payload = { 
//          ...travelForm, 
//          contractShortName: travelForm.projectName, 
//          category: 'Travel', 
//          userId: currentUserId 
//        };
...
//     } else {
//        payload = { 
//          employeeName: miscForm.employeeName,
//          officeLocation: miscForm.officeLocation,
//          items: miscForm.items, 
//          userId: currentUserId
//        };
...
//         alert(`${activeTab === 'travel' ? 'Travel' : 'Miscellaneous'} Report Saved! \nRecord ID: ${data.prime_key}`);
...
//                 className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 rounded-md text-xs font-black uppercase tracking-wider transition-all ${activeTab === 'travel' ? 'bg-white text-blue-700 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
//               >
//                 <Briefcase size={14}/> Travel
//               </button>
//               <button 
//                 onClick={() => setActiveTab('misc')}
//                 className={`flex-1 md:flex-none flex items-center justify-center gap-2 px-6 py-2 rounded-md text-xs font-black uppercase tracking-wider transition-all ${activeTab === 'misc' ? 'bg-white text-blue-700 shadow-sm' : 'text-slate-400 hover:text-slate-600'}`}
//               >
//                 <FileText size={14}/> Miscellaneous
//               </button>
//            </div>
//         </div>
...
//                    <h2 className="font-black text-slate-700 uppercase tracking-wide text-sm">Travel Details</h2>
//                 </div>

//                 <section className="space-y-3">
//                   <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Employee & Project</label>
//                   <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
...
//                            <span className="text-[9px] font-bold text-slate-500 uppercase block mb-1">From</span>
//                            <input id="travelFrom" type="date" className="w-full p-2 border rounded text-sm" value={travelForm.travelFrom} onChange={handleTravelChange}/>
//                         </div>
//                         <div className="col-span-1">
//                            <span className="text-[9px] font-bold text-slate-500 uppercase block mb-1">To</span>
//                            <input id="travelTo" type="date" className="w-full p-2 border rounded text-sm" value={travelForm.travelTo} onChange={handleTravelChange}/>
//                         </div>
...
//                    <h2 className="font-black text-slate-700 uppercase tracking-wide text-sm">Misc Report Details</h2>
//                 </div>
...
//                        <input id="officeLocation" placeholder="Office Location" className="w-full pl-8 p-2 border rounded text-sm" value={miscForm.officeLocation} onChange={handleMiscHeaderChange}/>
//                     </div>
//                   </div>
//                  </section>
...
//                        <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Itemized Expenses</label>
//                        <button type="button" onClick={addMiscRow} className="text-xs bg-blue-50 text-blue-600 px-3 py-1.5 rounded-full hover:bg-blue-100 font-bold flex gap-1 items-center transition-colors">
...
//                         <div key={index} className="bg-slate-50 p-4 rounded-lg border border-slate-200 relative group hover:shadow-md transition-shadow">
//                            <div className="grid grid-cols-12 gap-2 mb-2">
//                               <div className="col-span-7">
//                                 <span className="text-[9px] uppercase font-bold text-slate-400 block mb-1">Date</span>
//                                 <input type="date" className="w-full p-1 border rounded text-xs bg-white" value={item.date} onChange={(e) => handleMiscItemChange(index, 'date', e.target.value)} />
//                               </div>
...
//                                     <input type="number" className="w-full pl-4 p-1 border rounded text-xs font-bold text-right bg-white" value={item.amount} onChange={(e) => handleMiscItemChange(index, 'amount', e.target.value)} />
//                                 </div>
//                               </div>
//                            </div>
//                            <div className="mb-2">
//                               <span className="text-[9px] uppercase font-bold text-slate-400 block mb-1">Description</span>
//                               <input placeholder="Item Description" className="w-full p-1.5 border rounded text-xs bg-white" value={item.description} onChange={(e) => handleMiscItemChange(index, 'description', e.target.value)} />
//                            </div>
//                            <div className="grid grid-cols-2 gap-2">
//                               <div>
//                                   <span className="text-[9px] uppercase font-bold text-slate-400 block mb-1">Vendor</span>
...
//                               </div>
//                               <div>
//                                   <span className="text-[9px] uppercase font-bold text-slate-400 block mb-1">Business Purpose</span>
...
//                               </div>
//                            </div>
//                            {miscForm.items.length > 1 && (
//                              <button type="button" onClick={() => removeMiscRow(index)} className="absolute -top-2 -right-2 bg-white border border-red-100 text-red-500 p-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity shadow-sm hover:bg-red-50">
//                                <Trash2 size={12}/>
//                              </button>
//                            )}
//                         </div>
...
//               type="submit" 
//               disabled={isSaving}
//               className={`w-full text-white font-black py-4 rounded-lg shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2 uppercase tracking-tighter text-sm mt-6 ${isSaving ? 'bg-slate-400 cursor-not-allowed' : 'bg-yellow-500 hover:bg-yellow-600'}`}
//             >
//               {isSaving ? <Loader2 className="animate-spin" size={18} /> : <Save size={18}/>} 
//               {isSaving ? 'Saving...' : `Save ${activeTab === 'misc' ? 'Misc Report' : 'Travel Report'}`}
//             </button>
//           </form>
//         </div>
...
//                       <td className="border border-black p-1 font-bold">Per Diem: Lodging</td>
//                       <td className="border border-black p-1 bg-slate-100 text-center italic">Input</td>
//                       <td className="border border-black p-1 text-center font-bold text-black" colSpan="5">{travelForm.perDiemLodging || 0}</td>
//                     </tr>
//                     <tr>
//                       <td className="border border-black p-1 font-bold">Per Diem: M&IE</td>
//                       <td className="border border-black p-1 bg-slate-100 text-center italic">Input</td>
//                       <td className="border border-black p-1 text-center font-bold text-black" colSpan="5">{travelForm.perDiemMIE || 0}</td>
//                     </tr>
...
//                      <div className="grid grid-cols-[140px_1fr] items-end">
//                         <span className="font-bold">Employee Name:</span>
//                         <span className="border-b border-black uppercase px-2">{miscForm.employeeName}</span>
//                      </div>
//                      <div className="grid grid-cols-[140px_1fr] items-end">
//                         <span className="font-bold">Office Location:</span>
//                         <span className="border-b border-black uppercase px-2">{miscForm.officeLocation}</span>
//                      </div>
//                   </div>
...
//                               </tr>
//                            ))}
//                            {[...Array(Math.max(0, 12 - miscForm.items.length))].map((_, i) => (
