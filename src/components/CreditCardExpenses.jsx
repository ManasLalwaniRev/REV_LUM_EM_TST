...
//   onDataChanged,
//   contractOptions = [],
//   creditCardOptions = [] // Fetched from /api/credit-card-options
// }) => {
...
//                 <h1 className="text-3xl font-extrabold text-black-800">Credit Card Expenses</h1>
...
//                       {/* Mapping dynamically from DB options */}
...
//                   </div>
//                   <div className="lg:col-span-4 flex items-center gap-3 bg-white p-2 rounded border border-yellow-200">
...
//                     <label htmlFor="isApproved" className="text-xs font-bold text-yellow-800 uppercase cursor-pointer">Program Manager Approver</label>
//                   </div>
